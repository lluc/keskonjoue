import{a as n,j as e,i as l,d,B as t,l as p,m as C,D as i}from"./mui-C6qP3Lg6.js";import{s as I}from"./store.service-D_lAcI_b.js";import{A as m}from"./abcjs-C81N4upo.js";import{a as M}from"./index-Dcq-BEMD.js";const K={"sabotee_raves.abc":`M: 2/4
L: 1/4
Q: 200
K: G
%%stretchlast 1.0
...
w: None`},_={abcFiles:K},Q=()=>{const{slug:F}=M(),B=I.getRow("music",F||""),[G,o]=n.useState(!1),b=_.abcFiles[B.notation],a=n.useRef(new m.synth.CreateSynth),[h,E]=n.useState(null),[A,D]=n.useState(100),s=n.useRef(A);n.useLayoutEffect(()=>{if(b===void 0)return;const c=m.renderAbc("paper",b,{responsive:"resize",scrollHorizontal:!0});E(c)},[]),n.useEffect(()=>()=>{a.current.stop()},[]),n.useEffect(()=>{s.current=A},[A]);const f=()=>{if(h===null)return;const c=a.current;c.init({audioContext:new AudioContext,visualObj:h[0],millisecondsPerMeasure:h[0].millisecondsPerMeasure()*(100/s.current),options:{}}).then(()=>c.prime()).then(()=>{c.start(),o(!0)}).catch(r=>{console.warn("Audio problem:",r)})},g=()=>{G?(a.current.stop(),o(!1)):f()},V=(c,r)=>{Array.isArray(r)||(D(r),s.current=r,G&&(a.current.stop(),setTimeout(()=>f(),50)))};return e.jsxs(l,{spacing:2,children:[e.jsxs(d,{variant:"h3",children:[B.name,B.rights==1&&e.jsxs(d,{variant:"body1",color:"red",children:["© ",B.authors]})]}),b&&e.jsxs(l,{children:[e.jsx(t,{children:e.jsx(p,{variant:"contained",onClick:g,children:G?"Arrêter":"Jouer"})}),e.jsxs(t,{children:[e.jsxs(d,{id:"warp-slider",gutterBottom:!0,children:["Vitesse: ",A,"%"]}),e.jsx(C,{value:A,onChange:V,"aria-labelledby":"warp-slider",min:25,max:200,step:5,marks:[{value:50,label:"50%"},{value:100,label:"100%"},{value:150,label:"150%"}]})]}),e.jsx(t,{id:"paper"})]}),B.youtube&&e.jsxs(l,{spacing:2,children:[e.jsx(i,{}),e.jsx(d,{variant:"h5",children:"Vidéo"}),e.jsx(t,{component:"iframe",src:`https://www.youtube-nocookie.com/embed/${B.youtube}`,width:"100%",height:300,sx:{border:0},allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,loading:"lazy"})]})]})};export{Q as default};
