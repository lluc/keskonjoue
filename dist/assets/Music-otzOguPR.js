...
w: None`},w={abcFiles:_},x=()=>{const{slug:F}=u(),c=K.getRow("music",F||""),[h,s]=B.useState(!1),r=w.abcFiles[c.notation],n=B.useRef(null),[t,E]=B.useState(null),[l,D]=B.useState(100),[o,g]=B.useState(!1);B.useLayoutEffect(()=>{if(r===void 0)return;const A=m.renderAbc("paper",r,{responsive:"resize",scrollHorizontal:!0});E(A)},[]),B.useEffect(()=>{var a,f;if(t===null||r===void 0)return;const A=new m.synth.SynthController;return n.current=A,A.load("#audio-control",null,{displayLoop:!1,displayRestart:!1,displayPlay:!1,displayProgress:!1,displayWarp:!0}),A.setTune(t[0],!1,{qpm:((f=(a=t[0]).getBpm)==null?void 0:f.call(a))||120}).then(()=>{g(!0)}).catch(C=>{console.warn("Audio problem:",C)}),()=>{n.current&&n.current.pause()}},[t,r]);const V=()=>{!n.current||!o||(h?(n.current.pause(),s(!1)):(n.current.play(),s(!0)))},p=(A,a)=>{Array.isArray(a)||(D(a),n.current&&n.current.setWarp(a))};return e.jsxs(b,{spacing:2,children:[e.jsxs(G,{variant:"h3",children:[c.name,c.rights==1&&e.jsxs(G,{variant:"body1",color:"red",children:["© ",c.authors]})]}),r&&e.jsxs(b,{children:[e.jsx(d,{id:"audio-control",sx:{display:"none"}}),e.jsx(d,{children:e.jsx(i,{variant:"contained",onClick:V,disabled:!o,children:h?"Pause":"Jouer"})}),e.jsxs(d,{children:[e.jsxs(G,{id:"warp-slider",gutterBottom:!0,children:["Vitesse: ",l,"%"]}),e.jsx(I,{value:l,onChange:p,"aria-labelledby":"warp-slider",min:25,max:200,step:5,marks:[{value:50,label:"50%"},{value:100,label:"100%"},{value:150,label:"150%"}]})]}),e.jsx(d,{id:"paper"})]}),c.youtube&&e.jsxs(b,{spacing:2,children:[e.jsx(M,{}),e.jsx(G,{variant:"h5",children:"Vidéo"}),e.jsx(d,{component:"iframe",src:`https://www.youtube-nocookie.com/embed/${c.youtube}`,width:"100%",height:300,sx:{border:0},allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0,loading:"lazy"})]})]})};export{x as default};
